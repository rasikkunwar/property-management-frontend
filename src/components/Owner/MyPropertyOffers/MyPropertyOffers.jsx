...
import { fetchPropertyOffers, updatePropertyOffersStatus } from "../../../store/myPropertyApplications/myPropertyApplications";

const MyPropertyOffers = () => {


    const offers = useSelector((state) => state.myPropertyApplications.applications);
                                    ...
                                    <tr key={id}>
                                        ...
                                        <td className="icon-btn-container">
                                            ...
                                            <Button
                                                ...
                                                title="Reject"
                                                className="icon-btn"
                                                disabled={offer.status === "REJECTED" ? true : false}
